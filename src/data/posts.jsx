...
const allPosts = [
  ...
  },
  {
    ...
    tags: [
      ...
      { name: "QuickSight", background: "#FF9900", icon: <AWSQuickSightSVG /> },
  ...
  },
  {
    ...
    tags: [
      ...
      { name: "Comprehend", background: "#FF9900", icon: <AWSComprehendSVG /> },
      { name: "SageMaker", background: "#FF9900", icon: <AWSSageMakerSVG /> },
    ],
    intro: `Amazon Rekognition is a cloud-based image and video analysis service that makes it easy to add advanced computer vision capabilities to your applications. Amazon Rekognition includes a simple, easy-to-use API that can quickly analyze
  ...
  },
  {
    ...
    tags: [
      ...
      { name: "Shield", background: "#FF9900", icon: <AWSShieldSVG /> },
